...
class ChatController extends Controller
{
    ...
    {
        // 🚀 ATUALIZADO: Aceita os novos modos
        $request->validate([
        ...
        $texto         = $request->texto;
        $uc            = $request->uc;
        // 🚀 ATUALIZADO: Fallback para 'default'
        ...
        return response()->stream(function () use (
            ...
            if (!$socket) {
                echo "data: " . json_encode(['chunk' => "\n\n❌ Não foi possível ligar ao servidor Python: {$errstr}"]) . "\n\n";
                echo "data: [DONE]\n\n";
                flush();
                return;
            }
            ...
            while (!feof($socket)) {
                ...
                while (($newline = strpos($buffer, "\n")) !== false) {
                    ...
                    // Ignora linhas de chunked encoding e linhas vazias
                    if ($trimmed === '' || ctype_xdigit($trimmed)) continue;
